...
public class AirportSessionBean implements AirportSessionBeanRemote, AirportSessionBeanLocal {
    ...
    @Override
    public Long createAirport(String airportName, String airportCode, String country, String city, String state, int timeZone) {
        Airport newAirport = new Airport(airportName, airportCode, country, city, state, timeZone);
